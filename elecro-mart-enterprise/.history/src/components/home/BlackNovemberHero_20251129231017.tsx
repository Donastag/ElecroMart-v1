          ...
          <div className="relative h-[500px] flex items-center justify-center overflow-hidden">
            ...
            >
              {BUNDLES.map((bundle, index) => (
                <div key={bundle.id} className="flex-none w-full flex items-center justify-center min-w-0">
                  {/* Main Product Card - Laptop */}
                  <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] bg-gradient-to-br from-white to-gray-100 rounded-3xl shadow-2xl overflow-hidden transform -rotate-[12deg] hover:rotate-0 transition-all duration-500 hover:scale-105 z-20 group cursor-pointer animate-float">
                    <div className="aspect-[16/10] overflow-hidden bg-gray-100">
                      <img
                        src={bundle.products.main.image}
                        alt={bundle.products.main.name}
                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                      />
                    </div>
                    <div className="p-3 bg-white">
                      <p className="text-gray-500 text-xs font-medium uppercase tracking-wider">
                        {bundle.products.main.name.split(' ').slice(-2).join(' ')}
                      </p>
                      <h3 className="text-gray-900 font-bold text-base mt-1">
                        {bundle.products.main.name}
                      </h3>
                    </div>
                  </div>
                  ...
                  <div className="absolute right-1/2 top-1/2 translate-x-1/2 -translate-y-1/2 w-[250px] bg-gradient-to-br from-white to-gray-100 rounded-3xl shadow-2xl overflow-hidden transform rotate-[12deg] hover:rotate-0 transition-all duration-500 hover:scale-105 z-10 group cursor-pointer animate-float-delayed">
                    <div className="aspect-square overflow-hidden bg-gray-100">
                      <img
                        src={bundle.products.secondary.image}
                        alt={bundle.products.secondary.name}
                        className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700"
                      />
                    </div>
                    <div className="p-3 bg-white">
                      ...
                      <h3 className="text-gray-900 font-bold text-sm">
                        {bundle.products.secondary.name}
                      </h3>
