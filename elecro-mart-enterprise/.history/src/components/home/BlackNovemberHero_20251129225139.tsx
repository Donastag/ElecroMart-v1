      ...
      <div className="relative max-w-7xl mx-auto px-6 h-full flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full items-center">
          ...
          <div className="relative h-[500px] flex items-center justify-center">
            ...
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[250px] bg-gradient-to-br from-white to-gray-100 rounded-3xl shadow-2xl overflow-hidden transform rotate-3 hover:rotate-0 transition-all duration-500 hover:scale-105 z-10 group cursor-pointer">
