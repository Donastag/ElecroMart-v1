      ...
      <div className="relative max-w-7xl mx-auto px-6 h-full flex items-center">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 w-full items-center">
          ...
          <div className="space-y-6 z-10">
            {/* Flash Bundle Badge */}
            <div className="inline-flex items-center gap-2 bg-gradient-to-r from-orange-600 to-orange-500 text-white px-4 py-2 rounded-md text-sm font-bold uppercase tracking-wider shadow-lg shadow-orange-500/30 animate-pulse-fast">
            ...
            <div className="flex items-center gap-4 pt-4">
              <button className="group relative bg-white text-black px-8 py-4 rounded-xl text-lg font-bold uppercase tracking-wide overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-orange-500/50">
              ...
              {/* Countdown Timer */}
              <div className="bg-gray-900/80 backdrop-blur-sm border border-gray-800 rounded-xl px-6 py-4 flex items-center gap-3">
          ...
          <div className="relative h-[500px] flex items-center justify-center">
            ...
            <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[450px] bg-gradient-to-br from-white to-gray-100 rounded-3xl shadow-2xl overflow-hidden transform -rotate-3 hover:rotate-0 transition-all duration-500 hover:scale-105 z-20 group cursor-pointer">
              ...
              <div className="p-4 bg-white">
                ...
                <h3 className="text-gray-900 font-bold text-lg mt-1">
            ...
            {/* Plus Icon */}
            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-16 h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center shadow-xl z-30 animate-pulse">
              <div className="w-8 h-1 bg-white absolute" />
              <div className="w-1 h-8 bg-white absolute" />
            </div>

            {/* Secondary Product Card - Headphones */}
            <div className="absolute right-0 top-1/2 -translate-y-1/2 w-[380px] bg-gradient-to-br from-white to-gray-100 rounded-3xl shadow-2xl overflow-hidden transform rotate-3 hover:rotate-0 transition-all duration-500 hover:scale-105 z-10 group cursor-pointer">
